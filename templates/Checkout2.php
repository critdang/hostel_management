          ...
          <div class="checkout-item">
            ...
            <div class="checkout-item__detail">
              ...
              <div id="checkout-dropdown" class="dropdown-content">
                ...
                <p><?php echo $room['rooms'] > 1 ? $room['rooms'] . " rooms" : $room['rooms'] . " room" ?> </p>
              </div>
              <div class="checkout-item__info">
                <p><?php echo $room['adults'] > 1 ? $room['adults'] . " adults" : $room['adults'] . " adult" ?> </p>
              </div>
              <div class="checkout-item__info">
                <p><?php echo $room['children'] > 1 ? $room['children'] . " children" : $room['children'] . " child" ?> </p>
              </div>
